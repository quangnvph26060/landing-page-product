...
<body>
    ...
    <div id="SECTION2">
        ...
        <div class="position-relative border-bottom pb-3">
            <img width="217.254" height="28.654" src="./assets/img/1-20230922041846-a2w0l.png" alt=""
                align="left" />
            <span class="position-absolute fw-bold" style="top: 5px; left: 27px; color: rgb(72, 190, 190)">Voucher
                giảm phí vận chuyển</span>
            <p class="mb-0 fs-6" style="padding-top: 5px">
        ...
        <div class="px-1 py-3">
            ...
            <button class="px-5 py-2 text-light fw-bold fs-6 mt-2"
