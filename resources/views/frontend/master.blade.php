    ...
    <div class="container">
                    ...
                    <div class="col-6">
                        <div class="d-flex align-items-center justify-content-end gap-3 position-relative">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                version="1.2" baseProfile="tiny" x="0px" y="0px" viewBox="0 0 100 100"
                                xml:space="preserve" preserveAspectRatio="none" width="22px" height="22px"
                                class="" fill="#0A0A0A">
                                <path
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="22px" height="22px"
                                preserveAspectRatio="none" viewBox="0 0 24 24" class="" fill="#0A0A0A">
                                <path
                                    d="M17,18A2,2 0 0,1 19,20A2,2 0 0,1 17,22C15.89,22 15,21.1 15,20C15,18.89 15.89,18 17,18M1,2H4.27L5.21,4H20A1,1 0 0,1 21,5C21,5.17 20.95,5.34 20.88,5.5L17.3,11.97C16.96,12.58 16.3,13 15.55,13H8.1L7.2,14.63L7.17,14.75A0.25,0.25 0 0,0 7.42,15H19V17H7C5.89,17 5,16.1 5,15C5,14.65 5.09,14.32 5.24,14.04L6.6,11.59L3,4H1V2M7,18A2,2 0 0,1 9,20A2,2 0 0,1 7,22C5.89,22 5,21.1 5,20C5,18.89 5.89,18 7,18M16,11L18.78,6H6.14L8.5,11H16Z">
                                </path>
                            </svg>
                            <span class="position-absolute top-0 translate-middle badge rounded-pill bg-danger px-1"
                                style="font-size: 8px !important; right: 30px;">3</span>
        ...
        <div id="SECTION1">
            ...
            <div class="row px-2">
                <div class="col-4 d-flex align-items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                        ...
                        xml:space="preserve" preserveAspectRatio="none" width="22px" height="22px"
                        class="" fill='url("#SHAPE6_mobile_gradient")'>
                        <defs id="SHAPE6_defs">
                ...
                <div class="col-8 d-flex align-items-center gap-2 px-0 ">
                    ...
                    <p class="mb-0  fw-bold" style="color: rgb(28, 191, 192)">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            ...
                            style="enable-background: new 0 0 24 24" xml:space="preserve" preserveAspectRatio="none"
                            width="18px" height="18px" class="" fill="#1CBFC0">
                            <path
            ...
            <div style="background-color: #f9f5f2"
                class="mt-2 d-flex justify-content-between align-items-center px-1">
                <div class="d-flex align-items-center gap-2 py-2">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                        x="0px" y="0px" viewBox="0 0 66 66" style="enable-background: new 0 0 66 66"
                        xml:space="preserve" preserveAspectRatio="none" width="22px" height="22px"
                        class="" fill="rgba(156, 113, 49, 1)">
                        <g>
                            <path
            ...
            <div style="background-color: #f9f9f9" class="d-flex justify-content-evenly mt-2 py-2 " id="support">
                ...
                <div>
                    ...
                    <span style="font-size: 0.8rem">Hủy đơn dễ dàng</span>
                </div>
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                    ...
                    <span style="font-size: 0.8rem">Đội ngũ hỗ trợ 24/7</span>
                </div>
            </div>
        ...
        <div id="SECTION2">
            ...
            <div class="d-flex justify-content-between align-items-center mt-3 px-2">
                ...
                <p class="mb-0 ">
                    ...
                    <svg width="18" height="18" viewBox="0 0 50 50" xmlns="http://www.w3.org/2000/svg"
                        class="text-muted">
                        <polyline points="15,10 35,25 15,40" stroke="rgb(50, 50, 50)" stroke-width="2"
            ...
            <div class="position-relative border-bottom pb-3">
                <img width="217.254" height="28.654"
                    src="{{ asset('frontend/assets/img/1-20230922041846-a2w0l.png') }}" alt=""
                    align="left" />
        ...
        <div id="SECTION3" class="px-2">
            ...
            <div class="rating d-flex align-items-center gap-2 ">
                ...
                <span class="d-flex align-items-center">
                    <svg style="vertical-align: unset" xmlns="http://www.w3.org/2000/svg"
                        ...
                        preserveAspectRatio="none" width="16px" height="16px" class=""
            ...
            <div class="comments">
                ...
                <div class="mb-2">
                    ...
                    <img src="{{ asset('frontend/assets/img/osaka-fp126-20240808034656-knjji.jpg') }}" width="89"
        ...
        <div id="SECTION3">
            <div class="d-flex align-items-center gap-2 px-1">
                <div class="bg-light text-center rounded-circle" style="padding: 18px 0; width: 15%">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                        x="0px" y="0px" viewBox="0 0 100 100" enable-background="new 0 0 100 100"
                        xml:space="preserve" preserveAspectRatio="none" width="25px" height="25px"
                        class="" fill="#000">
                        <g>
                            <path
