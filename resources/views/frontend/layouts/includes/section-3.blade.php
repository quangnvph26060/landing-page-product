...
<div class="rating d-flex align-items-center gap-2 ">
    ...
    <span class="d-flex align-items-center">
        <svg style="vertical-align: unset" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
            version="1.1" x="0px" y="0px" viewBox="0 0 100 100" enable-background="new 0 0 100 100"
            xml:space="preserve" preserveAspectRatio="none" width="16px" height="16px" class=""
...
<div class="comments">
    ...
    <div class="my-1">
        <span class="d-flex align-items-center">
            <svg style="vertical-align: unset" xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewBox="0 0 100 100"
                enable-background="new 0 0 100 100" xml:space="preserve" preserveAspectRatio="none" width="14px"
                height="14px" class="" fill='url("#SHAPE6_mobile_gradient")'>
                <defs id="SHAPE6_defs">
                    <linearGradient id="SHAPE6_mobile_gradient" gradientTransform="rotate(0)">
                        <stop offset="0%" stop-color="#FACE15"></stop>
                        <stop offset="100%" stop-color="rgba(255, 221, 32, 1.0)"></stop>
